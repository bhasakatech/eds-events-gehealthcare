...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-event-page.js
  var import_event_page_exports = {};
  __export(import_event_page_exports, {
    default: () => import_event_page_default
  });
  ...
  function parse2(element, { document: document2 }) {
    ...
    const ctaText = ((_a = ctaEl == null ? void 0 : ctaEl.textContent) == null ? void 0 : _a.trim()) || "";
    const ctaHref = ((_b = ctaEl == null ? void 0 : ctaEl.getAttribute) == null ? void 0 : _b.call(ctaEl, "href")) || "";
    ...
    if (ctaText) {
      if (ctaHref) {
        ...
        parentCell.push(hint("cta"), document2.createTextNode(ctaText));
      }
    }
    cells.push([parentCell]);
    items.forEach((it) => {
      const labelCell = [hint("label"), document2.createTextNode(it.label)];
      const urlCell = [hint("url"), document2.createTextNode(it.url)];
  ...
  // tools/importer/parsers/products-solutions.js
  function parse4(element, { document: document2 }) {
    ...
    const descEl = [...container.querySelectorAll("p")].find((p) => p.textContent.trim());
    ...
    tiles.forEach((tile) => {
      ...
      const catTitle = ((_a2 = titleEl == null ? void 0 : titleEl.textContent) == null ? void 0 : _a2.trim()) || "";
      ...
      if (descTileEl && descTileEl.textContent.trim()) {
        const dd = document2.createElement("div");
    ...
    const block = WebImporter.Blocks.createBlock(document2, { name: "products-solutions", cells });
    element.replaceWith(block);
  }
  ...
  var parsers = {
    ...
    "section-nav": parse2,
    "video-text": parse3,
    "products-solutions": parse4,
    "feature-cards": parse5
  };
  var PAGE_TEMPLATE = {
    name: "event-page",
  ...
  return __toCommonJS(import_event_page_exports);
})();
